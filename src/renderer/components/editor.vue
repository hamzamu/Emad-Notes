<template>
    <div>
        <div class="statusbar">
            <div class="tag-group">
                <el-tag><b>Words:</b> {{count.words}}</el-tag>
                <el-tag><b>Sentences:</b>{{count.sentences}}</el-tag>
                <el-tag><b>Paragraphs:</b> {{count.paragraphs}}</el-tag>
                <el-tag><b>Caracters:</b> {{count.characters}}</el-tag>
                {{ meta.createdAt | moment("from", "now") }}
                {{ meta.updatedAt | moment("from", "now") }}
            </div>
        </div>
        <!--  -->
        <div class="container content" v-bind:style="{ backgroundImage: 'url(' + bg + ')' }">
            <div class="meta-editor" v-if="isMeta">
                ...
                <div class="meta-container">
                    ...
                    <div class="tag-group">
                        <div v-for="(i,index) in tags" v-bind:key="index">
                            <el-tag>{{i}}</el-tag><br />
                            <ul>
                                <li v-for="(i,index) in rdr(i)" v-bind:key="index">
                                    {{i.text}}
                                </li>
                            </ul>
                        </div>
            ...
            <div class="editor">
                ...
                <contenteditable id="editorBox" ref="editor" tag="div" :contenteditable="isEditable" v-model="content"
                    :noNL="false" @input="updateInput" @keydown.esc.native="exit" />
            </div>
        </div>
    </div>
</template>
